...
# from sum_json import make_one_json
...
# return
        ...
        print(self.imageDir)
        self.imageList = glob.glob(os.path.join(
            self.imageDir, '*.%s' % str(EXTENSION)))
